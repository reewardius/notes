...
class BurpExtender(IBurpExtender):
    ...
    def doPassiveScan(self, baseRequestResponse):
        ...
        # check if the request body contains a URL starting with http:// or https://
        if re.search(r"http[s]?://", requestBody):
            ...
            issue = SSRFIssue(baseRequestResponse.getHttpService(),
                              ...
                              "The request body contains a URL starting with http:// or https://: " + requestBody,
                              "High")
            # report the issue
            return [issue]
