#python script.py example.com -p http://1.2.3.4:8080
#python script.py example.com --proxy http://1.2.3.4:8080.
...
def main():
  ...
  parser.add_argument("-p", "--proxy", help="the proxy to use in the format 'protocol://ip:port'")
  ...
  for query in queries:
    ...
    t = threading.Thread(target=dorkthosethreads, args=(query, user_agent, args.output_file, args.proxy))
